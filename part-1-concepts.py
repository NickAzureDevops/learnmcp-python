...
try:
    ...
    # Provide fallback stubs if console_utils is missing
    def display_header(*args, **kwargs): pass
    def display_info_panel(*args, **kwargs): pass
    def display_success_panel(*args, **kwargs): pass
    def display_error_panel(*args, **kwargs): pass
    def display_code_panel(*args, **kwargs): pass
    def display_step(*args, **kwargs): pass
    def prompt_continue(*args, **kwargs): pass
    def section_separator(*args, **kwargs): pass
    def lab_complete(*args, **kwargs): pass
    async def async_show_progress(*args, **kwargs): pass
    class DummyConsole:
